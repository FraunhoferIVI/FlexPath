...
from src.differentiable_reward.reward_registry import AVAILABLE_REWARD_FUNCTIONS
...
class DifferentiableRewardFunction():
    ...
    def __init__(
        ...
        Initialize the DifferentiableRewardFunction.
